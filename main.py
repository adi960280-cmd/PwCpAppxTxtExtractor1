...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8241696754:AAFK_xH_EqkIY7C2nfoY1W44XzDbCSRlIK4")
...
async def start(bot, message):
  ...
  keyboard = [
    [
      InlineKeyboardButton("ðŸš€ Pw hila hila ke pelo ðŸš€", callback_data="pwwp")
    ],
    [
            ...
            for content in contents:
                if content['contentType'] == 1:
                    ...
                    if "media-cdn.classplusapp.com/tencent/" in url_val:
                       ...
                       filename = url_val.split("/")[-1].split(".")[0]
url_val = f"https://media-cdn.classplusapp.com/alisg-cdn-a.classplusapp.com/b08bad9ff8d969639b2e43d5769342cc62b510c4345d2f7f153bec53be84fe35/{filename}/master.m3u8"
